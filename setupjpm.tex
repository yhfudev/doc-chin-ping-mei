...
\newcommand\piWenglong[1]{ \ifnum\myEnablePi > 0  \myfootnote{{\fntfmyJiaozhu\myscriptsize\linespread{0.9} \color{darkpurple} 文龍批: #1}} \fi } % 批評 (文龍在茲堂本手書批評本批語)
%\newcommand\piWenglong[1]{ \ifnum\myEnablePi > 0  \myfootnote{文龍批: #1} \fi } % 批評 (文龍在茲堂本手書批評本批語)
...
本精校《金瓶梅》彙集有：
\ifnum\myEnablePi > 0
各家批評，如张竹坡\piZhang{\piZhanginfo}　李漁　\piLiyu{\piLiyuinfo}　文龍　\piWenglong{\piWenglonginfo}　等；
\fi
\ifnum\myEnableJiao > 0
各種校記，如
