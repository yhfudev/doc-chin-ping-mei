...
\newcommand\piZhang[1]{ \ifnum\myEnablePi > 0  \myfootnote{{\fntfmyJiaozhu\myscriptsize\linespread{0.9} \color{darkred} 【張評】 #1}} \fi } % 批評 (張竹坡皋鶴堂批評第一奇書批評本批語)
%\newcommand\piZhang[1]{ \ifnum\myEnablePi > 0  \myfootnote{【張評】 #1} \fi } % 批評 (張竹坡皋鶴堂批評第一奇書批評本批語)
...
\newcommand\piLiyu[1]{ \ifnum\myEnablePi > 0  \myfootnote{{\fntfmyJiaozhu\myscriptsize\linespread{0.9} \color{darkblue} 【繡本評】 #1}} \fi } % 批評 (李漁新刻繡像批評本批語)
%\newcommand\piLiyu[1]{ \ifnum\myEnablePi > 0  \myfootnote{【繡本評】 #1} \fi } % 批評 (李漁新刻繡像批評本批語)
...
\newcommand\piWenlong[1]{ \ifnum\myEnablePi > 0  \myfootnote{{\fntfmyJiaozhu\myscriptsize\linespread{0.9} \color{darkpurple} 【文龍評】 #1}} \fi } % 批評 (文龍在茲堂本手書批評本批語)
%\newcommand\piWenlong[1]{ \ifnum\myEnablePi > 0  \myfootnote{【文龍評】 #1} \fi } % 批評 (文龍在茲堂本手書批評本批語)
...
\newcommand\piMINE[1]{ \ifnum\myEnablePi > 0  \myfootnote{{\fntfmyJiaozhu\myscriptsize\linespread{0.9} \color{darkgreen} 【評】 #1}} \fi } % 批評 (我的)
...
\renewcommand\tmpfigscale{0.9}%{1.35}
